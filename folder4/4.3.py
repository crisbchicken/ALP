...
print(str(num1) + " plus " + str(num2) + " = " + str(total2))
# Instructions

# Line 4 creates an error. Look carefully to see what is wrong with the code and fix it. You need to make an integer
...
# Output num1, num2 and your new variable in a similar format to line 